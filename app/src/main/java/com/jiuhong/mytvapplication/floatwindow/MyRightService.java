...
public class MyRightService extends AccessibilityService implements View.OnClickListener {
...
//        wmParams.type = WindowManager.LayoutParams.TYPE_PHONE;
        ...
        //获取浮动窗口视图所在布局
        mFloatLayout = (LinearLayout) inflater.inflate(R.layout.layout_right_window, null);
        //添加mFloatLayout
